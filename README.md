...
This repository is at **M0 (bootstrapping/planning)**.
Core ping behavior, CLI compatibility, runtime loop, rendering, and parity work are scheduled for later milestones.
...
- **Windows:** best-effort via ICMP APIs; environment and policy can still block traffic.
